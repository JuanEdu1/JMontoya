...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-white via-white to-bone" />

      <div className="absolute -top-1/4 -right-1/4 w-[400px] sm:w-[600px] lg:w-[700px] h-[400px] sm:h-[600px] lg:h-[700px] bg-signal/15 rounded-full blur-[100px] sm:blur-[140px] animate-float" />
      <div className="absolute -bottom-1/4 -left-1/4 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-signal-dark/10 rounded-full blur-[100px] sm:blur-[120px]" />

      <div
        className="absolute inset-0 opacity-[0.05]"
        style={{
          backgroundImage: `linear-gradient(rgba(31,31,36,0.4) 1px, transparent 1px), linear-gradient(90deg, rgba(31,31,36,0.4) 1px, transparent 1px)`,
      ...
      <motion.div
        ...
        className="absolute top-1/2 right-0 w-1/3 h-px bg-gradient-to-r from-signal/60 to-transparent origin-right"
      />
      <motion.div
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 md:px-10 w-full pt-24 sm:pt-28 pb-12 sm:pb-16 z-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              {[
                ...
                >
                  ...
                  <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-ink/45">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-3 -right-3 w-full h-full border border-ink/10" />
        ...
        <motion.div
          ...
          className="hidden lg:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-ink/45"
        >
          <span className="text-[10px] uppercase tracking-[0.3em]">Scroll</span>
          <motion.div
            animate={{ y: [0, 10, 0] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
            className="w-px h-8 bg-ink/45"
          />
        </motion.div>
      </div>
    </section>
